package com.stechtricker.youplay.service
...
import com.stechtricker.youplay.MainActivity
import com.stechtricker.youplay.R
import com.stechtricker.youplay.enums.ExoPlayerDiskCacheMaxSize
import com.stechtricker.youplay.models.Event
import com.stechtricker.youplay.models.QueuedMediaItem
import com.stechtricker.youplay.query
import com.stechtricker.youplay.utils.InvincibleService
import com.stechtricker.youplay.utils.RingBuffer
import com.stechtricker.youplay.utils.TimerJob
import com.stechtricker.youplay.utils.YouTubeRadio
import com.stechtricker.youplay.utils.activityPendingIntent
import com.stechtricker.youplay.utils.broadCastPendingIntent
import com.stechtricker.youplay.utils.exoPlayerDiskCacheMaxSizeKey
import com.stechtricker.youplay.utils.findNextMediaItemById
import com.stechtricker.youplay.utils.forcePlayFromBeginning
import com.stechtricker.youplay.utils.forceSeekToNext
import com.stechtricker.youplay.utils.forceSeekToPrevious
import com.stechtricker.youplay.utils.getEnum
import com.stechtricker.youplay.utils.intent
import com.stechtricker.youplay.utils.isAtLeastAndroid13
import com.stechtricker.youplay.utils.isAtLeastAndroid6
import com.stechtricker.youplay.utils.isAtLeastAndroid8
...
import com.stechtricker.youplay.utils.mediaItems
import com.stechtricker.youplay.utils.persistentQueueKey
import com.stechtricker.youplay.utils.preferences
import com.stechtricker.youplay.utils.queueLoopEnabledKey
import com.stechtricker.youplay.utils.resumePlaybackWhenDeviceConnectedKey
import com.stechtricker.youplay.utils.shouldBePlaying
import com.stechtricker.youplay.utils.skipSilenceKey
import com.stechtricker.youplay.utils.timer
import com.stechtricker.youplay.utils.trackLoopEnabledKey
import com.stechtricker.youplay.utils.volumeNormalizationKey
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
                            ...
                            when (val status = body.playabilityStatus?.status) {
                                "OK" -> body.streamingData?.highestQualityFormat?.let { format ->
                                    ...
                                    query {
                                        ...
                                        Database.insert(
                                            com.stechtricker.youplay.models.Format(
                                                songId = videoId,
                                                itag = format.itag,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("com.stechtricker.youplay.pause")
            val play = Action("com.stechtricker.youplay.play")
            val next = Action("com.stechtricker.youplay.next")
            val previous = Action("com.stechtricker.youplay.previous")
        }
    }
